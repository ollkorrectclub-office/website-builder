...
export function PlanGenerationTraceCard({
  locale,
  dictionary,
  selectedRun,
  adapterRun,
    ...
    return (
      <Card className="px-5 py-5">
        <p className="text-xs uppercase tracking-[0.18em] text-muted-foreground">
          {dictionary.plan.generation.trace.title}
        </p>
        <p className="mt-4 text-sm text-muted-foreground">{dictionary.plan.generation.trace.empty}</p>
      </Card>
    );
  }
    ...
    return (
      <Card className="px-5 py-5">
        ...
        <p className="mt-2 text-sm leading-7 text-muted-foreground">
          {dictionary.plan.generation.trace.copy}
        </p>
        <div className="mt-4 rounded-[22px] border border-dashed border-border bg-background/60 p-4">
          <p className="text-sm text-muted-foreground">{dictionary.plan.generation.trace.noRun}</p>
        </div>
      </Card>
    );
  }
